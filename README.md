...
# 2. Download AppImage
# ZADARK_WGET
wget https://github.com/hthienloc/zalo-for-linux/releases/download/v26.5.10/Zalo-26.5.10+ZaDark-26.2-5051532.AppImage

# 3. Integrate with Gear Lever
# ZADARK_INTEGRATE
flatpak run it.mijorus.gearlever --integrate Zalo-26.5.10+ZaDark-26.2-5051532.AppImage --yes
...
# 2. Download AppImage
# ORIGINAL_WGET
wget https://github.com/hthienloc/zalo-for-linux/releases/download/v26.5.10/Zalo-26.5.10-5051532.AppImage

# 3. Integrate with Gear Lever
# ORIGINAL_INTEGRATE
flatpak run it.mijorus.gearlever --integrate Zalo-26.5.10-5051532.AppImage --yes
